...
**The recommended build environment is Linux**. On Windows, install link:https://learn.microsoft.com/en-us/windows/wsl/install[WSL] and continue from there. On Mac OS, it is recommended to use the Docker setup.
