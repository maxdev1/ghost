...
void canvas_t::checkBuffer()
{
    ...
    uint32_t requiredSize = G_UI_CANVAS_SHARED_MEMORY_HEADER_SIZE + cairo_format_stride_for_width(CAIRO_FORMAT_ARGB32, ALIGN_UP(bounds.width)) * ALIGN_UP(bounds.height);
