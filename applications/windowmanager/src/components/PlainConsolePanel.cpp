 ...
 *
 */
PlainConsolePanel::PlainConsolePanel() {
 ...
 *
 */
bool PlainConsolePanel::handle(Event& e) {
 ...
 *
 */
void PlainConsolePanel::append(char c) {
	content += c;
