 ...
 * microseconds when the <pitPerformSleep> function is called.
 *
...
/**
 * Performs sleep that was before configured using the <pitPrepareSleep>
 * function. A sleep can executed as often as wished onced its prepared.
 */
void pitPerformSleep();

/**
 * Starts the PIT in Channel 0 to fire IRQ 0 at the configured hertz rate.
 */
void pitStartTimer();
