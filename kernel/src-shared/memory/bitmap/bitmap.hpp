...
#ifndef GHOST_SHARED_MEMORY_BITMAP
#define GHOST_SHARED_MEMORY_BITMAP
...
#define G_BITMAP_LENGTH							(G_BITMAP_SIZE / sizeof(g_bitmap_entry))
#define G_BITMAP_BITS_PER_ENTRY					(sizeof(g_bitmap_entry) * 8)
