...
#define G_SYSCALL_WAIT_FOR_IRQ					10
#define G_SYSCALL_LOG							11
#define G_SYSCALL_SET_VIDEO_LOG					12
#define G_SYSCALL_TEST							13
#define G_SYSCALL_STORE_CLI_ARGUMENTS			14
#define G_SYSCALL_RELEASE_CLI_ARGUMENTS			15
#define G_SYSCALL_GET_WORKING_DIRECTORY			16
#define G_SYSCALL_SET_WORKING_DIRECTORY			17
#define G_SYSCALL_KILL							18
#define G_SYSCALL_ATOMIC_BLOCK					19
#define G_SYSCALL_REGISTER_IRQ_HANDLER			20
#define G_SYSCALL_RESTORE_INTERRUPTED_STATE		21
#define G_SYSCALL_REGISTER_SIGNAL_HANDLER		22
#define G_SYSCALL_RAISE_SIGNAL					23
#define G_SYSCALL_ATOMIC_TRY_LOCK				24
#define G_SYSCALL_KERNQUERY						25
#define G_SYSCALL_GET_EXECUTABLE_PATH			26
#define G_SYSCALL_GET_PARENT_PROCESS_ID			27
#define G_SYSCALL_EXIT_THREAD					28
...
#define G_SYSCALL_RAMDISK_SPAWN					70
#define G_SYSCALL_CREATE_THREAD					71
#define G_SYSCALL_GET_THREAD_ENTRY				71
#define G_SYSCALL_CREATE_EMPTY_PROCESS			73
#define G_SYSCALL_CREATE_PAGES_IN_SPACE			74
#define G_SYSCALL_ATTACH_CREATED_PROCESS		75
#define G_SYSCALL_CANCEL_PROCESS_CREATION		76
#define G_SYSCALL_GET_CREATED_PROCESS_ID		77
#define G_SYSCALL_WRITE_TLS_MASTER_FOR_PROCESS	78
#define G_SYSCALL_CONFIGURE_PROCESS				79
