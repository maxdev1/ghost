...
#define G_SYSCALL_CALL_FORK						0x106
#define G_SYSCALL_JOIN							0x107
#define G_SYSCALL_SLEEP							0x108
#define G_SYSCALL_ATOMIC_WAIT					0x109
...
#define G_SYSCALL_MAILBOX_SEND					0x403
#define G_SYSCALL_MAILBOX_RECEIVE				0x404
#define G_SYSCALL_MAILBOX_RECEIVE_WITH_IDENT	0x405
#define G_SYSCALL_MESSAGE_SEND					0x406
#define G_SYSCALL_MESSAGE_RECEIVE				0x407
#define G_SYSCALL_MESSAGE_RECEIVE_TRANSACTION	0x408
