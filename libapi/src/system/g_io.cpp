 ...
 */
void g_io_port_write_byte(uint16_t port, uint8_t value)
{
 ...
 * Writes the given data to the given CPU port
 */
void g_io_port_write_word(uint16_t port, uint16_t value)
{
 ...
 * Writes the given data to the given CPU port
 */
void g_io_port_write_dword(uint16_t port, uint32_t value)
{
