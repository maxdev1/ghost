...
#define G_SYSCALL_USER_MUTEX_INITIALIZE 		9
#define G_SYSCALL_USER_MUTEX_ACQUIRE			10
#define G_SYSCALL_USER_MUTEX_RELEASE			11
#define G_SYSCALL_USER_MUTEX_DESTROY			12
