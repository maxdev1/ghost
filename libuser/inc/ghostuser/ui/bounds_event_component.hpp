...
#ifndef GHOSTLIBRARY_UI_BOUNDS_EVENT_COMPONENT
#define GHOSTLIBRARY_UI_BOUNDS_EVENT_COMPONENT

#include <cstdint>
#include <ghost.h>
#include <ghostuser/ui/bounds_listener.hpp>
...
protected:
	...
	g_bounds_event_component(g_component* self, g_ui_component_id id) :
			self(self), id(id) {
	}
